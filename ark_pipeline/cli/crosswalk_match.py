...
from ark_pipeline.runtime.resources import configured_count, positive_int
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--threads", type=positive_int, default=configured_count("DUCKDB_THREADS"))
    parser.add_argument(
...
def main() -> None:
    ...
    stop_query_monitor = monitor_query(con, "Taxonomy matching query")
    ...
    con.execute(
        ...
        ) WHERE lower(trim(taxon_rank)) = 'species';
    ...
    manifest = {
        ...
        "sources": {
            ...
            "ncbi_merged": {
                "path": str((args.ncbi_taxdump_dir / "merged.dmp").resolve()),
                "sha256": sha256(args.ncbi_taxdump_dir / "merged.dmp"),
            },
            "ncbi_deleted": {
                "path": str((args.ncbi_taxdump_dir / "delnodes.dmp").resolve()),
                "sha256": sha256(args.ncbi_taxdump_dir / "delnodes.dmp"),
            },
        },
        "outputs": {
